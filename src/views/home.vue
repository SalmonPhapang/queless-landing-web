<template>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="hero-content">
            ...
            <p class="wow fadeInUp" data-wow-delay=".4s">
              Queless App allows you to order food and drinks from local restaurants and bottle stores with ease all from the comfort of your home.
              Providing delivery services to kasi's across south africa.
            </p>
        ...
        <div class="col-lg-6">
          <div class="hero-img wow fadeInUp" data-wow-delay=".5s">
            <img src="assets/img/order-food/5739256.jpg" alt="" width="700" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="single-service wow fadeInUp" data-wow-delay=".2s">
            ...
            <div class="content">
              <h3>Food</h3>
              <p>Order food from small businesses and support your local takeaway or restaurants spot.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="single-service wow fadeInUp" data-wow-delay=".4s">
            ...
            <div class="content">
              <h3>Grocery</h3>
              <p>See how much groceries cost before going to the store and get it delivered to your home.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="single-service wow fadeInUp" data-wow-delay=".6s">
            <div class="icon">
              <img src="assets/img/service/alcoholic-drink.png" alt="" />
            </div>
            <div class="content">
              <h3>Alcohol</h3>
              <p>Get alcohol delivered to you and ignore to line at bottle store, no petrol cost and dont drink and drive :)</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="about-img wow fadeInUp" data-wow-delay=".5s">
            <img src="assets/img/ordering-food/ordering-food.jpg" alt="" />
          </div>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row align-items-center">
        <div class="col-lg-5">
          <div class="delivery-content">
            <div class="section-title">
              ...
              <p class="mb-35 wow fadeInUp" data-wow-delay=".6s">We provide such a satisfactory service that your order will be at your door step withing 30 mins of ordering guaranteed.</p>
        ...
        <div class="col-lg-7 order-first order-lg-last">
          <div class="delivery-img wow fadeInUp" data-wow-delay=".5s">
            <img src="assets/img/delivery-service/3683230.jpg" alt="" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="about-img received-img wow fadeInUp" data-wow-delay=".5s">
            <img src="assets/img/delivery-concept/Delivery.jpg" alt="" />
          </div>
        </div>
        <div class="col-lg-6">
          <div class="about-content received-content">
            <div class="section-title">
              ...
              <p class="wow fadeInUp" data-wow-delay=".6s">COVID-19 is having a huge impact on the world and the country and it is up to every one of us to play our part to ensure that the spread and effects of the virus are limited as much as possible</p>
              <p class="wow fadeInUp" data-wow-delay=".6s">our drivers have been instructed not to make physical contact with any customers and to maintain a safe distance.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer id="footer" class="footer pt-100 pb-70">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="footer-widget wow fadeInUp" data-wow-delay=".2s">
            <div class="logo">
              <a href="#"><img src="assets/img/logo/logo-removebg.png" width="50" alt="logo" /></a>
            </div>
    ...
    <div class="hello fixed-bottom p-4">
      <div class="bg-dark text-white w-100 mw-100">
...
export default {
  ...
  mounted: function() {
    ...
    function cookieConsent() {
      if (!getCookie('qlessAllowCookies')) {
        $('.hello').show();
      }
    }

    $('#btnDeny').click(()=>{
      eraseCookie('qlessAllowCookies')
      $('.hello').hide();
    })

    $('#btnAccept').click(()=>{
      setCookie('qlessAllowCookies','1',7)
      $('.hello').hide();
    });
